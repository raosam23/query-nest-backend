...
1. Searches the web for relevant articles and scores each source for credibility
...
- **PostgreSQL** — Database (Neon in development, local Docker postgreSQL in Docker)
...
- [x] Sources endpoint
- [x] LLM-based credibility scoring
- [x] Dockerize
...
> Frontend repository: [querynest-frontend](https://github.com/raosam23/query-nest-frontend.git)
